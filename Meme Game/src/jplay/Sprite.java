...
public class Sprite extends Animation
{
    ...
    private int floor;
    private int creep_tipo,creep_lado;
    ...
    */
    ...
    public void setCreepTipo(int creep_tipo)
    {
            this.creep_tipo = creep_tipo;
    }
    
    public void setCreepLado(int creep_lado)
    {
            this.creep_lado = creep_lado;
    }
    ...
    public int getTipoCreep()
    {
            return this.creep_tipo;
    }
    
    public int getCreepLado()
    {
            return this.creep_lado;
    }
